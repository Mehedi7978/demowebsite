...
let photos = [
    'https://img.freepik.com/free-vector/open-book-vector_23-2147690155.jpg?ga=GA1.1.477320029.1724866833&semt=ais_hybrid',
...
let allindex=0;
function changetext(){
    all.innerHTML=text[allindex]

    allindex=(allindex+1)%text.length;

}

setInterval(changetext, 1234);





let maincontent=document.querySelector('.mainc');
